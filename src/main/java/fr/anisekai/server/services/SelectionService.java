...
@Service
public class SelectionService extends AnisekaiService<Selection, UUID, SelectionRepository> {
    ...
    public Selection createSelection(long amount) {
        ...
        // FIXME - Unproxy the instances
        List<Anime> unproxied = simulcasts.stream()
        ...
        entity.setAnimes(new HashSet<>(unproxied));
